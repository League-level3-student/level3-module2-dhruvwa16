...
public class MergeSorter extends Sorter {
	...
	private void mergeSort(int[] array, int low, int high, SortingVisualizer display) {
		//1. Create a temp integer array that is the same length as the passed in array.
		...
		if(low<high) {
            ...
            int middle2 = low + high;
            int middle = middle2/2;
           ...
           mergeSort(array, middle+1, high, display);
            //6. copy the elements from the array into the temp array,
